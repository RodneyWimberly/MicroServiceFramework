...
using MicroServicesFramework.Auth.Shared.Configuration.Email;
using MicroServicesFramework.Auth.Shared.Email;
    ...
    public static class StartupHelpers
    {
            ...
            where TDbContext : DbContext, IDataProtectionKeyContext
        {
            ...
            var dataProtectionBuilder = services.AddDataProtection()
                .SetApplicationName("MicroServicesFramework.Identity")
