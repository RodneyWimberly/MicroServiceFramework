...
using MicroServicesFramework.Auth.Admin.Api.AuditLogging;
using MicroServicesFramework.Auth.Admin.Api.Configuration;
using MicroServicesFramework.Auth.Admin.Api.Configuration.ApplicationParts;
...
namespace MicroServicesFramework.Auth.Admin.Api.Helpers
{
