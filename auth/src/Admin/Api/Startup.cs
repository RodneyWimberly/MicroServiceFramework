using MicroServicesFramework.Auth.Admin.Api.Configuration;
using MicroServicesFramework.Auth.Admin.Api.Configuration.Authorization;
using MicroServicesFramework.Auth.Admin.Api.ExceptionHandling;
using MicroServicesFramework.Auth.Admin.Api.Helpers;
using MicroServicesFramework.Auth.Admin.Api.Mappers;
using MicroServicesFramework.Auth.Admin.Api.Resources;
using MicroServicesFramework.Auth.Data.Shared.DbContexts;
using MicroServicesFramework.Auth.Data.Shared.Entities.Identity;
using MicroServicesFramework.Auth.Shared.Dtos;
using MicroServicesFramework.Auth.Shared.Dtos.Identity;
using MicroServicesFramework.Auth.Shared.Helpers;
...
namespace MicroServicesFramework.Auth.Admin.Api
{
