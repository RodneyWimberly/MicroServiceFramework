using AutoMapper;
using IdentityModel;
using MicroServicesFramework.Auth.Admin.Api.Configuration.Constants;
using MicroServicesFramework.Auth.Admin.Api.Dtos.Roles;
using MicroServicesFramework.Auth.Admin.Api.Dtos.Users;
using MicroServicesFramework.Auth.Admin.Api.ExceptionHandling;
using MicroServicesFramework.Auth.Admin.Api.Helpers.Localization;
...
namespace MicroServicesFramework.Auth.Admin.Api.Controllers
{
