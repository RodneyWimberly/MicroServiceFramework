...
log_header "logs: Creating file links for shared files."
...
link_file $SHARED_CONFIG/resolv.conf $LOGS_DIR/scripts/deployment/package/resolv.conf
link_file $SHARED_CONFIG/dhclient.conf $LOGS_DIR/scripts/deployment/package/dhclient.conf
link_file $SHARED_CONFIG/graylog.conf  $LOGS_DIR/scripts/deployment/package/graylog.conf

log_header "Making links for LogAgent"
...
log_header "Making links for Mongo"
...
log_header "Making links for ElasticSearch"
...
log_header "Making links for GrayLog"
