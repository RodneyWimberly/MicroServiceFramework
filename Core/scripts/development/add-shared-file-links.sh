...
log_header "core: Creating file links for shared files."
...
link_file $SHARED_CONFIG/rsyslog.conf $CORE_DIR/scripts/deployment/package/rsyslog.conf

log_header "Making links for Consul"
...
log_header "Making links for DNS"
...
log_header "Making links for Portainer"
...
log_header "Making links for Portainer-Agent"
...
log_header "Making links for Portal"
...
log_header "Making links for SSH Server"
...
log_header "Making links for Vault"
