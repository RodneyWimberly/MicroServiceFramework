...
run_consul_template /etc/templates/nginx.conf nginx.conf /etc/nginx/http.d/nginx.conf "consul lock -http-addr=http://consul.service.consul:8500 -name service/portal -shell=false reload nginx -s reload"
