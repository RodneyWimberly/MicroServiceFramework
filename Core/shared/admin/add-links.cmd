...
mklink /H %CORE_DIR%\consul\consul-functions.sh %CORE_DIR%\shared\scripts\consul-functions.sh
mklink /H %CORE_DIR%\consul\hosting-functions.sh %CORE_DIR%\shared\scripts\hosting-functions.sh
mklink /H %CORE_DIR%\consul\logging-functions.sh %CORE_DIR%\shared\scripts\logging-functions.sh
...
mklink /H %CORE_DIR%\dns\consul-functions.sh %CORE_DIR%\shared\scripts\consul-functions.sh
mklink /H %CORE_DIR%\dns\hosting-functions.sh %CORE_DIR%\shared\scripts\hosting-functions.sh
mklink /H %CORE_DIR%\dns\logging-functions.sh %CORE_DIR%\shared\scripts\logging-functions.sh
...
mklink /H %CORE_DIR%\portal\consul-functions.sh %CORE_DIR%\shared\scripts\consul-functions.sh
mklink /H %CORE_DIR%\portal\hosting-functions.sh %CORE_DIR%\shared\scripts\hosting-functions.sh
mklink /H %CORE_DIR%\portal\logging-functions.sh %CORE_DIR%\shared\scripts\logging-functions.sh
...
mklink /H %CORE_DIR%\vault\consul-functions.sh %CORE_DIR%\shared\scripts\consul-functions.sh
mklink /H %CORE_DIR%\vault\hosting-functions.sh %CORE_DIR%\shared\scripts\hosting-functions.sh
mklink /H %CORE_DIR%\vault\logging-functions.sh %CORE_DIR%\shared\scripts\logging-functions.sh
